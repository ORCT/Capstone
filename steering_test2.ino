...
void go_forward_motor1(int motor_dir_pin1, int motor_step_pin1, int motor_step, int motor_delay)
{
...
void go_forward_motor2(int motor_dir_pin2, int motor_step_pin2, int motor_step, int motor_delay)
{
