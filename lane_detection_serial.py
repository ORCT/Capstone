...
def get_steering_value(vp, height, width, steer_max=180, offset=0):#bigger height value is low position in the result picture that we saw
...
while int_delta != 0 or start_flag == 0:
    ...
    image = cv2.imread('Python/lane_test/solidWhiteCurve.jpg') # import image, be careful the path!!
